...
contract ERC721BasicToken is SupportsInterfaceWithLookup, ERC721Basic {
  ...
  function approve(address _to, uint256 _tokenId) public {
    // YOUR CODE HERE
    require(isApprovedOrOwner(msg.sender, _tokenId) == true);
    address approvalAddress = tokenApprovals[_tokenId];
    if(approvalAddress == 0)
    {
    ...
    returns (bool)
  {
    ...
    if((_spender == ownerAddress) || (_spender == approvalAddress) || (operatorApprovals[ownerAddress][_spender])) 
    {
        return true;
    }
    else
